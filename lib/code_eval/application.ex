defmodule CodeEval.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      CodeEvalWeb.Endpoint
    ]

    # See https://hexdocs.pm/elixir/Supervisor.html
    # for other strategies and supported options
    opts = [strategy: :one_for_one, name: CodeEval.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    CodeEvalWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
